...
export async function printDocument(printData: any) {
  ...
  try {
    ...
    printer.print(printData); // Append text
    ...
    printer.getBuffer(); // Returns printer buffer // Set the printer buffer to a copy of newBuffer
    printer.getWidth();
